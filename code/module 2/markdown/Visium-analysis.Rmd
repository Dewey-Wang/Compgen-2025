...
<a href="../index.html" style="margin-right: 20px; text-decoration: none;"> ← Back to Note</a> <a href="https://github.com/Dewey-Wang/Compgen-2025" target="_blank" style="text-decoration: none;"> View on GitHub</a>
...
> If you want to reproduce the experiment: 👉 [Click here to the Docker and the data setup instructions](#environment--dataset-setup)
...
MBrain_Sec <- readRDS("./RDS/MBrain_Sec_1.rds")
p1 <- vrEmbeddingPlot(MBrain_Sec, embedding = "umap")
p2 <- vrEmbeddingPlot(MBrain_Sec, embedding = "umap", group.by = "Clusters")
...
```{r, echo=FALSE}
MBrain_Sec <- readRDS("./RDS/MBrain_Sec_2.rds")
```
...
[**Download all datasets (ZIP)**](#0) **- including datasets for other markdown**
...
-   **Visium – Mouse Brain**
    -   [Sagittal Anterior](https://www.10xgenomics.com/datasets/mouse-brain-serial-section-1-sagittal-anterior-1-standard-1-1-0)
    -   [Sagittal Posterior](https://www.10xgenomics.com/datasets/mouse-brain-serial-section-1-sagittal-posterior-1-standard-1-1-0)
-   **scRNA-seq Reference – Allen Brain**
    -   [Publication](https://www.nature.com/articles/nn.4216)
    -   [Download RDS](https://www.dropbox.com/s/cuowvm4vrf65pvq/allen_cortex.rds?dl=1)
